    ...
    <div class="container lg:w-1/2 md:w-4/5 w-11/12 mx-auto mt-8 px-8 bg-image-charenge shadow-md rounded-md">
        ...
        <form action="{{ route('charenges.store') }}" method="POST" class="rounded pt-3 pb-8 mb-4">
            ...
            <div class="mb-4">
                ...
                <textarea name="body" class="rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-pink-600 w-full py-2 px-3" id="body" cols="30" rows="5"
                required placeholder="チャレンジ企画の詳細、参考URL、投稿方法等ご記入ください。">{{ old('body') }}</textarea>
            </div>
            <div class="mb-4">
