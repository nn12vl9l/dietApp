...
<body class="antialiased">
    ...
    <div class="relative min-h-screen flex">
        <div
            ...
            <div class="h-full flex flex-auto text-black bg-cover relative bg-image bg-opacity-25">
                <div
                    class="w-4/5 flex flex-auto flex-col md:flex-row items-center justify-center p-10 xl:p-32 overflow-hidden">
                    <div class="z-10">
                        <div class="text-3xl sm:text-6xl xl:text-7xl font-mono text-gray-700 leading-tight mb-6">Share'ett
                        </div>
                        <div class="sm:text-sm xl:text-md text-black-200 font-normal text-center">
                ...
                <div
                    ...
                    <div class="text-center text-black">
                        ...
                        <p class="flex flex-col items-center justify-center mt-10 text-center text-md ">
                            ...
                            <a href=/register
                                class="mt-6 w-full flex justify-center bg-gradient-to-r from-green-500 to-blue-600 hover:bg-gradient-to-l hover:from-blue-500 hover:to-green-600 text-gray-100 p-4 rounded-full tracking-wide font-semibold shadow-lg cursor-pointer transition ease-in duration-500">Sign
                                up</a>
                        </p>
                    </div>
                </div>
